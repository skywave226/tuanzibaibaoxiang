...
> 本文档是 `tuanzibaibaoxiang` 项目的结构化代码 Wiki，涵盖项目整体架构、模块职责、关键类与函数、依赖关系及运行方式。
...
**团子百宝箱** 是一个纯前端的在线工具集合（SPA），基于 **Vue 3 + TypeScript + Vite 6** 构建，提供 **160+** 离线/在线实用工具，覆盖文本处理、图片处理、编码转换、网络工具、开发工具、安全工具、SEO 工具、设计工具、生成器、计算工具、生活计算、日期时间等多个分类。
