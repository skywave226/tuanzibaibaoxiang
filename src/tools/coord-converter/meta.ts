export default {
  ...
  description: '游戏坐标系转换工具，支持屏幕/世界/笛卡尔/极坐标/等距/瓦片坐标互转，以及 2D/3D 变换矩阵计算',
  category: '游戏开发',
  keywords: ['坐标', 'coordinate', '转换', '屏幕坐标', '世界坐标', '极坐标', '等距', '瓦片', 'tile', '变换矩阵', 'rotation', 'scale'],
}
